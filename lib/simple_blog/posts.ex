defmodule SimpleBlog.Posts do
  ...
  ################################################################################
  ### Delete number of comments for a specific post
  ...
  ################################################################################
  def delete_all_comments (post_id) do
    post_comments = Comments.get_all_comments(post_id)
    for post_comment <- post_comments do
      Comments.delete_comment(post_comment)
    end
  end
